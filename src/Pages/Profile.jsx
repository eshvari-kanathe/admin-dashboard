    ...
    <Sidebar/>
      ...
      >
        ...
        >
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
              <a className="nav-link  active" href="../pages/profile.html">
                <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <svg
                    width="12px"
                    height="12px"
      ...
      <div className="main-content position-relative max-height-vh-100 h-100">
            ...
            >
              ...
              <ul className="navbar-nav justify-content-end">
                <li className="nav-item d-flex align-items-center">
                  <a
                    className="btn btn-outline-white btn-sm mb-0 me-3"
                    target="_blank"
        ...
        <div className="container-fluid">
          <div className="page-header min-height-250 border-radius-lg mt-4 d-flex flex-column justify-content-end">
            <span className="mask bg-primary opacity-9" />
            <div className="w-100 position-relative p-3">
              <div className="d-flex justify-content-between align-items-end">
                <div className="d-flex align-items-center">
                  <div className="avatar avatar-xl position-relative me-3">
                    <img
                  ...
                  <div>
                    <h5 className="mb-1 text-white font-weight-bolder">
                      Alec Thompson
                    </h5>
                    <p className="mb-0 text-white text-sm">CEO / Co-Founder</p>
                  </div>
                </div>
                <div className="d-flex align-items-center">
                  <a
                    href="javascript:;"
                    className="btn btn-outline-white mb-0 me-1 btn-sm"
                  >
                    Billing
                  </a>
                  <a
                    href="javascript:;"
                    className="btn btn-outline-white mb-0 btn-sm"
                  >
                    Payments
                  </a>
                </div>
                    ...
                    <div className="col-xl-3 col-md-6 mb-xl-0 mb-4">
                      <div className="card card-blog card-plain">
                        ...
                        <div className="card-body px-1 pb-0">
                          <p className="text-secondary mb-0 text-sm">Project #2</p>
                          <a href="javascript:;">
                            <h5 className="font-weight-bolder">Modern</h5>
                          </a>
                    ...
                    <div className="col-xl-3 col-md-6 mb-xl-0 mb-4">
                      <div className="card card-blog card-plain">
                        ...
                        <div className="card-body px-1 pb-0">
                          ...
                          <a href="javascript:;">
                            <h5 className="font-weight-bolder">Scandinavian</h5>
                          </a>
                          <p className="mb-4 text-sm">
                    ...
                    <div className="col-xl-3 col-md-6 mb-xl-0 mb-4">
                      <div className="card card-blog card-plain">
                        ...
                        <div className="card-body px-1 pb-0">
                          ...
                          <a href="javascript:;">
                            <h5 className="font-weight-bolder">Minimalist</h5>
                          </a>
                          <p className="mb-4 text-sm">
