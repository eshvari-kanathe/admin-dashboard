...
const Rtl = () => {
  return <div>
    ...
    <Sidebar/>
      {/* <aside
        className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret"
        id="sidenav-main"
      >
        <div className="sidenav-header">
          ...
          >
            <img
              ...
              alt="main_logo"
            />
            <span className="me-1 font-weight-bold">Soft UI Dashboard 3</span>
          </a>
        </div>
          ...
          <ul className="navbar-nav">
            <li className="nav-item">
              <a className="nav-link " href="../pages/dashboard.html">
                <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
                  <svg
                    width="12px"
                    height="12px"
                    viewBox="0 0 45 40"
          ...
          >
            ...
            <div className="card-body text-start p-3 w-100">
              ...
              <div className="docs-info">
                <h6 className="text-white up mb-0 text-end">تحتاج مساعدة?</h6>
                <p className="text-xs font-weight-bold text-end">
            ...
            <div className="collapse navbar-collapse mt-sm-0 mt-2 px-0" id="navbar">
              ...
              <ul className="navbar-nav me-auto ms-0 justify-content-end">
                <li className="nav-item d-flex align-items-center">
                  <a
                    className="btn btn-outline-primary btn-sm mb-0 ms-3"
                    target="_blank"
                        ...
                        <div className="d-flex py-1">
                          ...
                          <div className="d-flex flex-column justify-content-center">
                            <h6 className="text-sm font-weight-normal mb-1">
                              <span className="font-weight-bold">رسالة جديدة</span>{" "}
                              من لور
                            </h6>
                            <p className="text-xs text-secondary mb-0 ms-auto">
                    ...
                    <li className="mb-2">
                      ...
                      >
                        <div className="d-flex py-1">
                          ...
                          <div className="d-flex flex-column justify-content-center">
                            <h6 className="text-sm font-weight-normal mb-1">
                              <span className="font-weight-bold">البوم جديد</span>{" "}
                              بواسطة ترافيس سكوت
                            </h6>
                            <p className="text-xs text-secondary mb-0 ms-auto">
                              <i className="fa fa-clock me-1" />
                      ...
                      >
                        <div className="d-flex py-1">
                          ...
                          <div className="d-flex flex-column justify-content-center">
                            ...
                            <p className="text-xs text-secondary mb-0 ms-auto">
                              <i className="fa fa-clock me-1" />2 أيام
                            </p>
                          </div>
                        </div>
                      </a>
                ...
                <div className="card-body p-3">
                  <div className="row">
                    ...
                    <div className="col-lg-4 me-auto ms-0 text-center">
                      <div className="bg-primary border-radius-lg min-height-200">
                        <img
              ...
              <div className="card">
                <div className="card-body p-3">
                  ...
                  <p className="text-sm ms-2">
                    {" "}
                    (<span className="font-weight-bolder">+23%</span>) من الأسبوع
                    الماضي{" "}
                  </p>
                    ...
                    <div className="row">
                      <div className="col-3 py-3 ps-0">
                        <div className="d-flex mb-2">
                          <div className="icon icon-shape icon-xxs shadow border-radius-sm bg-primary text-center ms-2 d-flex align-items-center justify-content-center">
                            <svg
                              width="10px"
                              height="10px"
                              viewBox="0 0 40 44"
                  ...
                  <div className="row mb-3">
                    <div className="col-6">
                      ...
                      <p className="text-sm">
                        ...
                        <span className="font-weight-bold ms-1">30 انتهى</span> هذا
                        الشهر
                      </p>
                    </div>
                        ...
                        <tr>
                          <td>
                            <div className="d-flex px-2 py-1">
                              ...
                              <div className="d-flex flex-column justify-content-center">
                                <h6 className="mb-0 text-sm">Soft UI XD الإصدار</h6>
                              </div>
                            </div>
                          </td>
                          <td>
        ...
        <div className="card shadow-lg ">
          ...
          <div className="card-body pt-sm-3 pt-0">
            ...
            <div className="d-flex">
              ...
              <button
                className="btn btn-primary w-100 px-3 mb-2 me-2"
                data-class="bg-white"
                onclick="sidebarType(this)"
              >
                White
