...
import smalllogo from "../Assets/img/small-logos/logo-xd.svg"
...
import DashboardTable from "../ReusableComponents/Tables/DashboardTable";
import DashboardReview from "../ReusableComponents/DashboardReview";
  ...
  const data = [
    {
      ...
      logo: smalllogo,
      members: [
        { name: "Ryan Tompson", avatar: team1 },
        { name: "Romina Hadid", avatar: team2 },
        { name: "Alexander Smith", avatar: team3 },
        { name: "Jessica Doe", avatar: team4 },
      ],
      budget: "$14,000",
      completion: 60,
    ...
    },
    {
      ...
      logo: slack,
      members: [
        { name: "Romina Hadid", avatar: team3 },
        { name: "Jessica Doe", avatar: team1 },
      ],
      budget: "Not set",
      completion: 100,
    ...
    },
    {
      ...
      logo: spotify,
      members: [
        { name: "Ryan Tompson", avatar: team4 },
        { name: "Romina Hadid", avatar: team3 },
        { name: "Alexander Smith", avatar: team4 },
        { name: "Jessica Doe", avatar: team4 },
      ],
      budget: "$20,500",
      completion: 100,
    ...
    },
    {
      ...
      logo: jira,
      members: [{ name: "Ryan Tompson", avatar: team4 }],
      budget: "$500",
      completion: 25,
      completionColor: "info",
    },
                      ...
                      {ordersData.map((order, index) => (
                        <div key={index} className="timeline-block mb-3">
                          <span className="timeline-step">
                            <i className={`ni ${order.icon} text-${order.color} text-gradient`} />
                          </span>
                          <div className="timeline-content">
                            <h6 className="text-dark text-sm font-weight-bold mb-0">{order.title}</h6>
