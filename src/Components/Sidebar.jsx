            ...
            >
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item" onClick={()=>navigate("/tables")}>
                        <p to="/tables" className="nav-link">
                            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg
                                    width="12px"
                                    height="12px"
                    ...
                    <li className="nav-item" onClick={()=>navigate("/billing")}>
                        <p to="/billing" className="nav-link">
                            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg
                                    width="12px"
                                    height="12px"
                    ...
                    <li className="nav-item" onClick={()=>navigate("/virtualreality")}>
                        <p to="/virtualreality" className="nav-link">
                            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg
                                    width="12px"
                                    height="12px"
                    ...
                    <li className="nav-item" onClick={()=>navigate("/rtl")}>
                        <p to="/rtl" className="nav-link">
                            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg
                                    width="12px"
                                    height="12px"
                    ...
                    <li className="nav-item" onClick={()=>navigate("/signin")}>
                        <p to="/signin" className="nav-link">
                            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg
                                    width="12px"
                                    height="12px"
                    ...
                    <li className="nav-item" onClick={()=>navigate("/signup")}>
                        <p to="/signup" className="nav-link">
                            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg
                                    width="12px"
                                    height="20px"
